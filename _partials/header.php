            ...
            <div class="flex items-center">
                ...
                <div class="hidden md:block">
                    <div class="ml-10 flex items-baseline space-x-4">
                        ...
                        <a href="#" class="rounded-md px-3 py-2 text-sm font-medium text-gray-300 hover:bg-gray-700 hover:text-white">Quiz</a>
                        <a href="#" class="rounded-md px-3 py-2 text-sm font-medium text-gray-300 hover:bg-gray-700 hover:text-white">Code Challenges</a>
                        ...
                        <div>
                            <button
                                ...
                                <div
                                    ...
                                    data-name="<?php echo htmlspecialchars($_SESSION['name'] ?? $_SESSION['email'] ?? 'User'); ?>">
                                </div>
                            </button>
                        </div>
